####################################################################################################
# POST-PROCESSING FOR SS2 SCENARIO II
####################################################################################################
...
for (sim in 1:10) {
  # load(paste0("Simulation_Study_2/Scripts_Results/SS2_SII_CJ/Output_SS2_SII_CJ_Simulation_", sim, ".Rdata"))
  load(paste0("/Volumes/My Passport/PhD/PhD Project 1/LaPCoM_Code/Simulation_Study_2/Scripts_Results/SS2_SII_CJ/Output_SS2_SII_CJ_Simulation_", sim, ".Rdata"))
...
# POST-PROCESSING
# ------------------------------------------------------------------------------------------------
pp_res_II = post_process_LaPCoM(output = output_combined,
                            multi = output_combined[[1]]$sim_multi$multi,
                            plots_path = "Simulation_Study_2/Post_Processing/SS2II_CJ_PP/PP_Plots_II/")
save(pp_res_II, file = "Simulation_Study_2/Post_Processing/SS2II_CJ_PP/pp_res_II.Rdata")  
