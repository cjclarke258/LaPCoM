####################################################################################################
# POST-PROCESSING FOR SS2 SCENARIO III
####################################################################################################
...
for (sim in 1:10) {
  # load(paste0("Simulation_Study_2/Scripts_Results/SS2_SIII_CJ/Output_SS2_SIII_CJ_Simulation_", sim, ".Rdata"))
  load(paste0("/Volumes/My Passport/PhD/PhD Project 1/LaPCoM_Code/Simulation_Study_2/Scripts_Results/SS2_SIII_CJ/Output_SS2_SIII_CJ_Simulation_", sim, ".Rdata"))
...
# POST-PROCESSING
# ------------------------------------------------------------------------------------------------
pp_res_III = post_process_LaPCoM(output = output_combined,
                             multi = output_combined[[1]]$sim_multi$multi,
                             plots_path = "Simulation_Study_2/Post_Processing/SS2III_CJ_PP/PP_Plots_III/")
save(pp_res_III, file = "Simulation_Study_2/Post_Processing/SS2III_CJ_PP/pp_res_III.Rdata")  
